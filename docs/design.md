...
| Embedded assistant | Server-side LLM harness (Claude Agent SDK) confined to the ten `pkm-mcp` verbs; floating chat panel with SSE streaming and confirm-gated writes. | [Spec](superpowers/specs/2026-07-26-pkm-wn2s-assistant-design.md) · [plan](superpowers/plans/2026-07-26-pkm-wn2s-assistant.md) |

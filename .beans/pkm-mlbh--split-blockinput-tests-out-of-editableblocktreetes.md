...
updated_at: 2026-08-02T18:25:55Z
parent: pkm-6phf
---

Follow-up to pkm-64bq: after the BlockInput extraction, roughly half of EditableBlockTree.test.tsx's 112 tests exercise BlockInput. Move them to a BlockInput.test.tsx as a standalone test-only change (deliberately not done during the refactor so the safety net stayed byte-stable).
